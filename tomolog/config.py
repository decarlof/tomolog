...
CONFIG_FILE_NAME = os.path.join(str(pathlib.Path.home()), 'tomolog.conf')
...
SECTIONS['tomolog'] = {
    'doc-dir': {
        'type': str,
        'default': '.',
        'help': "sphinx/readthedocs documentation directory where the tomolog data table extracted from the hdf5 file should be saved, e.g. docs/source/..."},
    'doc-file-prefix': {
        'type': str,
        'default': 'log',
...
tomolog_PARAMS = ('tomolog', )

NICE_NAMES = ('General', 'Tomo log')
...
def show_config(args):
    ...
    log.warning('tomolog status end')
